...
AFRAME.registerComponent('tt-particle-system', {
    schema: {
        preset: {
            type: 'string',
            default: '',
    ...
    initParticleSystem(settings) {
        ...
        const particle_texture = loader.load(
            settings.texture,
            texture => texture,
            (xhr) => {
        ...
        const emitter = new SPE.Emitter({
            ...
            color: {
                value: settings.color.map(c => new THREE.Color(c)),
            },
            size: {
                value: settings.size,
            },
            ...
            opacity: { value: settings.opacity.map(o => parseFloat(o)) },
