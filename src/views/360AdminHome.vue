<template>
    <v-content class="admin-home background lighten-3">
...
import DefaultApp from '@/tt-core/scenes/360Tour/app';
...
export default {
    ...
    data: () => ({
        ...
        newApp: {
            ...
            config: JSON.stringify(DefaultApp.config),
            state: JSON.stringify(DefaultApp.state),
            actions: JSON.stringify(DefaultApp.actions),
        },
        newAppDialog: false,
