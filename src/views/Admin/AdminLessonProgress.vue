<template>
    <LMSLayout>
        ...
        <template v-slot:SubPages>
            <v-tabs class="ml-4">
                <v-tabs-slider color="light-blue" />

                <v-tab
                    class="font-weight-600 text-h3 text-capitalize"
                ...
                <v-tab
                    class="font-weight-600 text-h3 text-capitalize"
                    :to="'/course/' + $route.params.courseId + '/sections'"
                >
                    Sections
                </v-tab>
                <v-tab
                    class="font-weight-600 text-h3 text-capitalize"
                    :to="'/course/' + $route.params.courseId + '/progress'"
                >
                    Progress
                </v-tab>
            </v-tabs>
